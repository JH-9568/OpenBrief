...
from openbrief.models import BriefRevision, Integration, NotificationDelivery, Project, Provider
...
def format_brief_notification(project: Project, revision: BriefRevision) -> str:
    ...
    return (
        f"[OpenBrief] {project.name} daily brief is ready.\n"
        ...
        "Open OpenBrief to review the cited brief and approve the revision."
    )
